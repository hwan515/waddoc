...
const MeasureIntro = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-[#061A40] font-sans relative overflow-hidden text-center cursor-pointer" onClick={() => navigate('/robot/measure/temperature')}>
            ...
            <main className="relative z-10 w-full max-w-4xl space-y-12 animate-fade-in-up">
                ...
                <div className="space-y-3">
                    <h1 className="text-3xl md:text-4xl font-semibold text-[#B9D6F2] tracking-tight">
                        비대면진료 시작 전,
                    </h1>
                    <h2 className="text-3xl md:text-4xl font-semibold text-[#B9D6F2] tracking-tight">
                        환자분의 건강정보를 측정합니다.
                    </h2>
                </div>

                <div className="text-5xl md:text-3xl text-[#B9D6F2] font-medium tracking-wide">
                    총 <span className="text-white font-bold">4단계</span>로 <span className="text-white font-bold">체온, 혈압, 심전도, 산소포화도</span>를 측정합니다.
                </div>

                <div className="text-4xl md:text-3xl font-medium text-[#B9D6F2] tracking-wide pt-4">
            ...
            <div className="absolute bottom-10 text-[#B9D6F2]/50 text-sm animate-pulse">
                화면을 터치하면 바로 시작합니다
            </div>
        </div>
    );
