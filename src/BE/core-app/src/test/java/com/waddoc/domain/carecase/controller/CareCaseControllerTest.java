    ...
    void getCaseDetail_usesDocumentedCasePath() throws Exception {
        when(careCaseQueryService.getCaseDetail(eq("case_test123"), any()))
                .thenReturn(CaseDetailResponse.builder()
                        ...
                        .consultationHistories(java.util.List.of(
                                CaseDetailResponse.ConsultationHistory.builder()
                                        .caseId("case_prev001")
        ...
        mockMvc.perform(get("/api/v1/cases/{caseId}", "case_test123"))
                ...
                .andExpect(jsonPath("$.consultationHistories[0].caseId").value("case_prev001"))
                .andExpect(jsonPath("$.consultationHistories[0].doctorName").value("Doctor Kim"))
                .andExpect(jsonPath("$.consultationHistories[0].isPrescriptionIssued").value(true))
