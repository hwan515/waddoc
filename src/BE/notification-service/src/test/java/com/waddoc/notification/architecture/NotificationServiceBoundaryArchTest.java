package com.waddoc.notification.architecture;
...
class NotificationServiceBoundaryArchTest {

    @ArchTest
    static final ArchRule notification_service_should_not_depend_on_other_service_persistence_or_config =
            noClasses()
                    .should()
                    .dependOnClassesThat()
                    .resideInAnyPackage(
